...
export const Select: React.FC<SelectProps> = ({
  ...
  return (
    <select
      className={cn(
        'select select-bordered rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 border-slate-300 dark:border-slate-700 transition-colors focus:border-primary focus:outline-none',
        sizeStyles[size],
        fullWidth && 'w-full',
