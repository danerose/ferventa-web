  ...
  (
    ...
    return (
      <input
        ...
        onChange={onChange}
        className={cn(
          // NumberInput uses font-mono for monospaced numeric legibility (JetBrains Mono)
          'w-full font-mono rounded border-[#cbd5e1] text-[#0b1c30] placeholder:text-gray-400 outline-none transition-all duration-150',
