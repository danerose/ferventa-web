...
const colorMap = {
  primary: 'focus:border-primary border-base-300',
  secondary: 'focus:border-secondary border-base-300',
  accent: 'focus:border-accent border-base-300',
  neutral: 'focus:border-neutral border-base-300',
  info: 'focus:border-info border-info/30',
  success: 'focus:border-success border-success/30 bg-success/5',
  warning: 'focus:border-warning border-warning/30 bg-warning/5',
  error: 'focus:border-error border-error/30 bg-error/5',
};
...
const variantMap = {
  ...
  bordered: 'border-2 border-base-300 bg-base-100 text-base-content',
  ghost: 'border-transparent bg-transparent hover:bg-base-200 focus:bg-base-100 focus:border-base-300 text-base-content',
  soft: 'border-transparent bg-base-200 text-base-content hover:bg-base-300 focus:bg-base-100 focus:border-base-content/20',
};

export const AutocompleteInputAtom = React.forwardRef<HTMLInputElement, AutocompleteInputProps>(
  (
    {
      options = [],
      value = '',
      ...
      <div ref={containerRef} className={cn('relative w-full', className)}>
        <div className="relative">
          <input
            ...
            className={cn(
              'w-full pr-10 font-sans rounded border-base-300 text-base-content placeholder:text-base-content/40 outline-none transition-all duration-150',
              'focus:ring-0 focus:border-2',
              disabled && 'bg-base-200 text-base-content/40 cursor-not-allowed opacity-60',
              variantMap[variant],
              colorMap[color],
              sizeMap[size],
...
AutocompleteInputAtom.displayName = 'AutocompleteInputAtom';

export const AutocompleteInput = AutocompleteInputAtom;
