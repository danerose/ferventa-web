...
export const PERMISSIONS = {
  ...
  INVENTORY_RECEPTION_CREATE: 'inventory.reception_create',
  INVENTORY_RECEPTION_APPROVE: 'inventory.reception_approve',
  INVENTORY_BOX_OPEN: 'inventory.box_open',
...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  [UserRole.Warehouse]: [
    PERMISSIONS.BRANCHES_VIEW,
    PERMISSIONS.INVENTORY_VIEW,
    PERMISSIONS.INVENTORY_RECEPTION_CREATE,
    PERMISSIONS.INVENTORY_BOX_OPEN,
