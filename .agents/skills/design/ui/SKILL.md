...
The palette is anchored by **Slate 900 (#1e293b)**, providing a professional, "industrial blue" foundation that ensures high contrast for text and primary navigation. **Amber 500 (#f59e0b)** is reserved strictly for high-priority actions, warnings, and active status indicators, mimicking automotive caution lights. **Emerald 500 (#10b981)** handles positive confirmations and successful states.

- **Primary:** Navigation, primary buttons, and structural headers.
- **Secondary/Warning:** Secondary actions, pending statuses, and alerts.
- **Tertiary/Success:** Completed repairs, paid invoices, and positive stock levels.
- **Neutral:** UI borders, secondary text, and inactive states.
...
The design system employs a **Rounded** shape language, moving away from sharp industrial edges to a more modern, approachable software feel.

- **Components:** Buttons, inputs, and small widgets use a 0.5rem (8px) radius to ensure a balanced, professional look.
- **Containers:** Large cards and dashboard panels use a 1rem (16px) radius.
- **Indicators:** Status badges (chips) are fully rounded (pill-shaped) to distinguish them from interactive buttons.

This increased rounding softens the high-contrast industrial color palette, aligning the system with contemporary enterprise application standards.

## Components

### Buttons
- **Primary:** Solid #1e293b with white text. 8px radius. High emphasis.
...
### Inputs & Fields
- **Default State:** 1px border #cbd5e1, 8px radius.
- **Focus State:** 2px border #1e293b.
- **Critical Data:** Use monospaced font for price and quantity inputs.

### Chips/Badges
- **Status Indicators:** Use light tinted backgrounds with dark text (e.g., Success: Emerald light background with #10b981 text). Use pill-shaped rounding.
...
### Cards
- White background, 1px border #e2e8f0. 16px (1rem) corner radius.
